 ...
 * @authors    Alec Yin
 * @date       Thu Nov 03 2016 17:47:08 GMT+0800 (中国标准时间)
...
!function(t){var e={init:function(t,e){this.wrapper=t,this.wrapper.empty(),this.options=e,this.wrapper.append(this.fillHtml()),this.bindEvent()},fillHtml:function(){var t=this.options.pageTotal,e=this.options.pageIndex,n=this.options.pageSize,i=Math.floor(t/n);t%n!=0&&(i+=1),0==i&&i++;var a="",o=e-1;o+3>i&&(o=i-3),o<0&&(o=0);var r=o+3;i<4&&(r=i),a+="<ul class='c_page'>",a+=Turtle.stringFormat("<li toPageIndex='$1'>上一页</li>",0==e?"":e-1),e>1&&o>0&&(a+=Turtle.stringFormat("<li class='$3' toPageIndex='$2'>$1</li>",1,0==e?"":0,0==e?"select":"")),e>2&&(a+=Turtle.stringFormat("<b>...</b>"));for(var s=o;s<r;s++)a+=Turtle.stringFormat("<li class='$3' toPageIndex='$2'>$1</li>",s+1,s==e?"":s,s==e?"select":"");return i>4&&e+1<i-2&&(a+=Turtle.stringFormat("<b>...</b>")),i>3&&e+1<i-1&&(a+=Turtle.stringFormat("<li class='$3' toPageIndex='$2'>$1</li>",i,i-1==e?"":i-1,i-1==e?"select":"")),a+=Turtle.stringFormat("<li toPageIndex='$1'>下一页</li>",e==i-1?"":e+1),this.options.isShowTotal&&(a+=Turtle.stringFormat("<b class='total'>共$1页</b>",i)),this.options.isInputPageIndex&&(a+=Turtle.stringFormat("到第<input id='txtPageNum' type='number' min='1' max='$1' value=''>页",i),a+="<button>确定</button>"),a+=Turtle.stringFormat("</ul>")},bindEvent:function(){this.wrapper.on("click","li",function(n){var i=t(this).attr("toPageIndex");i&&e.OnPageChange(i)}),this.wrapper.on("click","button",function(){e.OnPageChange("-1","jumpPage")}),this.wrapper.on("keyup","input#txtPageNum",function(){var e=t(this).attr("max");e=+e;var n=+t(this).val();n>e&&t(this).val(n.toString().substring(0,n.toString().length-1))})},OnPageChange:function(e,n){if(e=+e+1,"jumpPage"==n&&(e=t("#txtPageNum").val()),e)if(this.options.onPageClick)this.options.onPageClick(e);else{var i=document.location.href;i=/pageIndex=/.test(i)?i.replace(/pageIndex=\d+/,"pageIndex="+e):document.location.search?i+"&pageIndex="+e:i+"?pageIndex="+e,document.location.href=i}}};t.fn.createPage=function(n){n=n||{};var i=t.extend({pageTotal:0,pageIndex:0,pageSize:12,isInputPageIndex:!1,isShowTotal:!1},n);e.init(this,i)}}(jQuery);
