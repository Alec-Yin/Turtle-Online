 ...
 * @authors    Alec Yin
 * @date       Fri Nov 11 2016 14:11:10 GMT+0800 (中国标准时间)
...
!function(t){var e={init:function(t,e){this.wrapper=t,this.wrapper.empty(),this.options=e,this.wrapper.append(this.fillHtml()),this.bindEvent()},fillHtml:function(){var t=this.options.pageTotal,e=this.options.pageIndex,a=this.options.pageSize,n=Math.floor(t/a);t%a!=0&&(n+=1),0==n&&n++;var i="",r=e-1;r+3>n&&(r=n-3),r<0&&(r=0);var o=r+3;n<4&&(o=n),i+="<ul class='c_page'>",i+=Turtle.stringFormat("<li toPageIndex='$1'>上一页</li>",0==e?"":e-1),e>1&&r>0&&(i+=Turtle.stringFormat("<li class='$3' toPageIndex='$2'>$1</li>",1,0==e?"":0,0==e?"select":"")),e>2&&(i+=Turtle.stringFormat("<b>...</b>"));for(var s=r;s<o;s++)i+=Turtle.stringFormat("<li class='$3' toPageIndex='$2'>$1</li>",s+1,s==e?"":s,s==e?"select":"");return n>4&&e+1<n-2&&(i+=Turtle.stringFormat("<b>...</b>")),n>3&&e+1<n-1&&(i+=Turtle.stringFormat("<li class='$3' toPageIndex='$2'>$1</li>",n,n-1==e?"":n-1,n-1==e?"select":"")),i+=Turtle.stringFormat("<li toPageIndex='$1'>下一页</li>",e==n-1?"":e+1),this.options.isShowTotal&&(i+=Turtle.stringFormat("<b class='total'>共$1页</b>",n)),this.options.isInputPageIndex&&(i+=Turtle.stringFormat("到第<input id='txtPageNum' type='number' min='1' max='$1' value=''>页",n),i+="<button>确定</button>"),i+=Turtle.stringFormat("</ul>")},bindEvent:function(){this.wrapper.on("click","li",function(a){var n=t(this).attr("toPageIndex");n&&e.OnPageChange(n)}),this.wrapper.on("click","button",function(){e.OnPageChange("-1","jumpPage")}),this.wrapper.on("keyup","input#txtPageNum",function(){var e=t(this).attr("max");e=+e;var a=+t(this).val();a>e&&t(this).val(a.toString().substring(0,a.toString().length-1))})},OnPageChange:function(e,a){if(e=+e+1,"jumpPage"==a&&(e=t("#txtPageNum").val()),e)if(this.options.onPageClick)this.options.onPageClick(e);else{var n=document.location,i=n.href;i=/pageIndex=/.test(i)?i.replace(/pageIndex=\d+/,"pageIndex="+e):n.search?i.replace(n.hash,"")+"&pageIndex="+e+n.hash:i.replace(n.hash,"")+"?pageIndex="+e,document.location.href=i}}};t.fn.createPage=function(a){a=a||{};var n=t.extend({pageTotal:0,pageIndex:0,pageSize:12,isInputPageIndex:!1,isShowTotal:!1},a);e.init(this,n)}}(jQuery);
