...
;!function(turt){
    ...
    Dates.view = function(elem, options){
        ...
        if(!Dates.box){
            div = doc[creat]('div');
            div.id = as[0];
            div.className = 'laydate_body skin_'+(options.skin || config.skin)+' '+as[0];
            ...
            Dates.box.className=Dates.box.className.replace(/skin_\S*/g,'skin_'+(options.skin || config.skin));
